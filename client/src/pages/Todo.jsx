            ...
            <form onSubmit={formik.handleSubmit} className='my-20 py-20 flex flex-col justify-between items-center bg-white min-h-[70vh] min-w-[55%]'>
              ...
              <div className="form-date-group flex flex-row justify-between w-2/3">
                ...
                <label htmlFor="endTime" className='text-xl py-1'>Start</label>
                  <input type='datetime-local' name="startTime" id="startTime" onChange={formik.handleChange} onClockClose={formik.handleBlur} value={formik.values.startTime} />
                  {formik.touched.startTime && formik.errors.startTime ? <div className='pt-1 text-xs text-red-600'>{formik.errors.name}</div> : null}
                </div>
                <div className="form-group flex flex-col w-2/5">
                  <label htmlFor="endTime" className='text-2xl py-1'>End</label>
                  <input type='datetime-local' name="endTime" id="endTime" onChange={formik.handleChange} onClockClose={formik.handleBlur} value={formik.values.endTime} />
